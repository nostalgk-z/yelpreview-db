...
class CheckInRepository {
    ...
    async all() {
        return this.db.any('SELECT * FROM checkin');
    }

    // Returns the total number of users;
    async total() {
        return this.db.one('SELECT count(*) FROM checkin', [], a => +a.count);
    }
}
...
function createColumnsets(pgp) {
    ...
    if (!cs.insert) {
        ...
        const table = new pgp.helpers.TableName({table: 'checkin', schema: 'public'});
